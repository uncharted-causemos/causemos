...
import { ParameterFacetsBuilder, FACET_TYPES, PARAMETER_TYPES } from '@/utils/data/ParameterFacetsBuilder';
...
describe('utils/data/ParameterFacetsBuilder', () => {
  ...
  it('should return filtered runs', () => {
    ...
    const runIds = facetsBuilder.applyFilters(filters).runs().map(run => run.id);
