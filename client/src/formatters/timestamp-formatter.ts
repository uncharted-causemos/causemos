...
export default function (timestamp: number, breakdownOption: string|null, temporalResolution: TemporalResolutionOption|null) {
  ...
  return dateFormatter(timestamp, temporalResolution === TemporalResolutionOption.Year ? 'YYYY' : 'MMMM YYYY');
}
