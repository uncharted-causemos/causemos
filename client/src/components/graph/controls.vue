<template>
  <div
    ...
    <div class="graph-setting graph-setting-border-right layouts">
      <select
        v-tooltip="nodeButtonTitles.layout"
        @change="setLayoutAlgorithm">
        <option
          disabled
          value=""
        >Please select one layout</option>
        <option
          v-for="item in selectableLayouts"
          :key="item"
          :value="item"
          :selected="layout.layoutOption === item"
        >{{ LAYOUT_LABELS[item] }}</option>
      </select>
      <select
        v-if="layout.layoutOption === LAYOUTS.COLA"
        @change="setLayoutDirection">
        <option
    ...
    <div
      ...
      <div
        ...
        class="graph-setting search-buttons"
      >
        <button
          ...
          class="btn btn-primary btn-sm"
          @click="addToSearch()"
        ><i class="fa fa-plus-circle" /><i class="fa fa-search" /></button>
        <button
          v-tooltip="nodeButtonTitles.exclude"
          type="button"
          class="btn btn-primary btn-sm"
          @click="removeFromSearch()"
        ><i class="fa fa-minus-circle" /><i class="fa fa-search" /></button>
      </div>
    </div>
  </div>
</template>
