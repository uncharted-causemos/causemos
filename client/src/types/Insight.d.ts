...
export interface Bookmark {
  ...
  target_view: string; // main tab when the bookmark was saved, e.g., data, qualitative, quantitative.

  // actions to be applied before/after applying this bookmark
  ...
  pre_actions?: any; // e.g., remove noisy UI elements that should not be part of the bookmark image/context
