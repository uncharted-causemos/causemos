...
import SearchBar from '@/components/kb-explorer/search-bar.vue';
import TabPanel from '@/components/kb-explorer/tab-panel.vue';
import FacetsPanel from '@/components/kb-explorer/facets-panel.vue';
import DrilldownPanel from '@/components/drilldown-panel.vue';
import EvidencePane from '@/components/drilldown-panel/evidence-pane.vue';
import MultiRelationshipsPane from '@/components/drilldown-panel/multi-relationships-pane.vue';
...
import ModalAddedToCag from '@/components/modals/modal-added-to-cag.vue';
