...
const FIELDS = Object.freeze({
  ...
  factorMonth: {
    fields: [
      'subj.time_context.start.month',
      'obj.time_context.start.month', // start
      'subj.time_context.end.month',
      'obj.time_context.end.month', // end
    ],
  ...
  factorYear: {
    fields: [
      'subj.time_context.start.year',
      'obj.time_context.start.year', // start
      'subj.time_context.end.year',
      'obj.time_context.end.year', // end
    ],
    type: FIELD_TYPES.RANGED,
    level: FIELD_LEVELS.STATEMENT,
  },
