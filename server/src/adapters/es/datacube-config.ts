...
const makeRanges = (startYear: number, endYear: number) => {
...
export const NESTED_FIELD_PATHS = Object.freeze({
  CONCEPTS: 'ontology_matches',
});

export const FIELDS: Record<string, any> = Object.freeze({
  id: { fields: ['id'], type: FIELD_TYPES.NORMAL, level: FIELD_LEVELS.DATACUBE },
  dataId: { fields: ['data_id'], type: FIELD_TYPES.NORMAL, level: FIELD_LEVELS.DATACUBE },
  newVersionId: {
    fields: ['new_version_data_id'],
    type: FIELD_TYPES.NORMAL,
    level: FIELD_LEVELS.DATACUBE,
  },
  keyword: { fields: [], type: FIELD_TYPES.REGEXP, level: FIELD_LEVELS.DATACUBE },
  category: {
    fields: ['category'],
  ...
  description: { fields: ['description'], type: FIELD_TYPES.REGEXP, level: FIELD_LEVELS.DATACUBE },
  dataSensitivity: {
    fields: ['data_sensitivity'],
    type: FIELD_TYPES.REGEXP,
    level: FIELD_LEVELS.DATACUBE,
  },
  dataQuality: { fields: ['data_quality'], type: FIELD_TYPES.REGEXP, level: FIELD_LEVELS.DATACUBE },
  country: {
  ...
  status: { fields: ['status'], type: FIELD_TYPES.NORMAL, level: FIELD_LEVELS.DATACUBE },
  period: {
  ...
  type: { fields: ['type'], type: FIELD_TYPES.NORMAL, level: FIELD_LEVELS.DATACUBE },
  temporalResolution: {
  ...
  outputName: { fields: ['outputs.name'], type: FIELD_TYPES.NORMAL, level: FIELD_LEVELS.DATACUBE },
  conceptName: {
...
// Re-export FIELD_TYPES from config for consumers that import from datacube-config
export { FIELD_TYPES } from './config';
